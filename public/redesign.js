...
panels.rewards.querySelector('.workspace-heading p:last-child').textContent = 'The BaseStock10 token is live on Base. 2,100 USDC in rewards has been distributed to date.';
document.querySelector('.rewards-teaser .soon-pill').textContent = 'TOKEN LIVE ON BASE';
document.querySelector('.rewards-teaser p').textContent = 'BaseStock10 is live on Base. 2,100 USDC in rewards has been distributed to date.';
...
document.querySelector('.buy-launch').innerHTML = `<p>Eligible BaseStock10 holders can receive ten-stock rewards.</p><small>2,100 USDC in rewards has been distributed to date. Eligibility and distribution rules can change.</small><a class="contract-link" href="${baseStockTokenUrl}" target="_blank" rel="noreferrer">VIEW CONTRACT ↗</a><a class="buy-token" href="https://kyberswap.com/swap/base/usdc-to-0x51276d0322421b9a903132b3867bcda2587cfee1" target="_blank" rel="noreferrer">BUY BASESTOCK10 ↗</a>`;
intro.lastElementChild.innerHTML = '<span>USDC REWARDS DISTRIBUTED</span><strong>2,100 <small>USDC</small></strong><p>Distributed to date</p>';
hero.querySelector('.network').insertAdjacentHTML('afterend', '<div class="hero-reward-callout"><span>USDC REWARDS DISTRIBUTED</span><strong>2,100 <small>USDC</small></strong><p>Distributed to date</p></div>');
routeHash();
})();
