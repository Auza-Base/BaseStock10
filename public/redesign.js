...
panels.rewards.querySelector('.workspace-heading p:last-child').textContent = 'The BaseStock10 token is live on Base. More than $2,100 worth of stock rewards have been distributed to date.';
document.querySelector('.rewards-teaser .soon-pill').textContent = 'TOKEN LIVE ON BASE';
document.querySelector('.rewards-teaser p').textContent = 'BaseStock10 is live on Base. More than $2,100 worth of stock rewards have been distributed to date.';
